...
export const ClientDashboard: React.FC<ClientDashboardProps> = ({
  ...
  const btcPrice = btcAsset ? btcAsset.price : 94850;
  ...
  return (
    <div className="space-y-6 max-w-full overflow-x-hidden">
      {/* ================= TOP TICKER BAR WITH CRYPTO LOGOS ================= */}
        ...
        <div className="flex items-center justify-between min-w-[720px] divide-x divide-[#1e2d48]/70">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-base font-bold text-white font-mono">
                  {btcAsset
                    ? btcAsset.price.toLocaleString(undefined, {
          ...
          <div className="px-4 flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-base font-bold text-white font-mono">
                  {ethAsset
                    ? ethAsset.price.toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                      })
                    : '3,420.73'}
          ...
          <div className="px-4 flex items-center gap-3">
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-[#dc2626] text-white text-[9px] font-black flex items-center justify-center shadow-sm">
                500
              </span>
          ...
          <div className="px-4 flex items-center gap-3">
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-[#2563eb] text-white text-[9px] font-black flex items-center justify-center shadow-sm">
                100
              </span>
          ...
          {/* Right: TradingView Partner Emblem */}
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3 text-xs sm:text-sm text-white/85 font-mono">
              ...
              <span>•</span>
              <span className="text-white/80">{t.availableBalance}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap">
            <button
              ...
              className="px-6 py-3.5 rounded-2xl bg-white text-[#0070d6] hover:bg-slate-100 font-extrabold text-xs sm:text-sm uppercase tracking-wider shadow-xl hover:shadow-2xl transition-all flex items-center gap-2 transform active:scale-95 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 rounded-2xl bg-white/20 hover:bg-white/30 text-white border border-white/35 font-extrabold text-xs sm:text-sm uppercase tracking-wider backdrop-blur-md shadow-lg hover:shadow-xl transition-all flex items-center gap-2 transform active:scale-95 cursor-pointer"
            >
      ...
      {/* ================= INSTITUTIONAL LIQUIDITY GATEWAY BANNER ================= */}
      <div className="p-4 sm:p-5 rounded-2xl border border-blue-500/30 bg-gradient-to-r from-blue-950/40 via-[#0f1c38] to-[#0b1325] shadow-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <div className="text-sm font-bold text-white mt-0.5">{t.withdrawTitle}</div>
        ...
        <div className="flex items-center gap-2 self-stretch sm:self-auto shrink-0">
          <button
            onClick={() => onNavigate('withdraw')}
            className="w-full sm:w-auto px-5 py-2.5 rounded-xl font-extrabold text-xs shadow-md bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-blue-500/20 flex items-center justify-center gap-1.5 transition-all cursor-pointer"
          >
            <span>{t.navWithdraw}</span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <button
          ...
          className="p-4 rounded-xl bg-[#0b1325] hover:bg-[#111c34] border border-[#162238] hover:border-blue-500/40 text-left transition-all group shadow-sm flex items-center gap-3 cursor-pointer"
        >
        ...
        <button
          ...
          className="p-4 rounded-xl bg-[#0b1325] hover:bg-[#111c34] border border-[#162238] hover:border-emerald-500/40 text-left transition-all group shadow-sm flex items-center gap-3 cursor-pointer"
        >
        ...
        <button
          ...
          className="p-4 rounded-xl bg-[#0b1325] hover:bg-[#111c34] border border-[#162238] hover:border-cyan-500/40 text-left transition-all group shadow-sm flex items-center gap-3 cursor-pointer"
        >
          ...
          <div>
            ...
            <div className="text-[11px] text-slate-400">{t.marketOrder}</div>
          </div>
        </button>
        ...
        <button
          ...
          className="p-4 rounded-xl bg-[#0b1325] hover:bg-[#111c34] border border-[#162238] hover:border-amber-500/40 text-left transition-all group shadow-sm flex items-center gap-3 cursor-pointer"
        >
        ...
        <div className="bg-[#0b1325] border border-[#162238] rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          ...
          <div className="text-xs text-slate-400 mt-3 pt-3 border-t border-slate-800/80 flex items-center justify-between gap-2 flex-wrap">
            {user.withdrawalClearance?.accountUpgraded ? (
              ...
              <span className="text-slate-400 font-normal">Standard Brokerage Tier</span>
            )}
            {user.kycStatus !== 'verified' && (
              <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Watchlist with Bitcoin & Ethereum logos */}
        <div className="lg:col-span-2 bg-[#0b1325] border border-[#162238] rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <Activity className="w-4 h-4 text-blue-400" />
              <h3 className="font-bold text-white text-sm">{t.liveMarketsWatchlist}</h3>
            </div>
            <button
              onClick={() => onNavigate('trading')}
          ...
          <div className="divide-y divide-[#172338]">
            {markets.slice(0, 6).map((m) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <CryptoIcon symbol={baseSymbol as any} size="sm" />
                    <div>
                  ...
                  <button
                    onClick={() => onNavigate('trading')}
                    className="px-3 py-1 rounded-lg bg-blue-600/20 hover:bg-blue-600 text-blue-400 hover:text-white border border-blue-500/30 text-xs font-bold transition-all ml-4 cursor-pointer"
                  >
                    {t.tradeBtn}
                  </button>
                </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-white text-sm">{t.recentActivity}</h3>
              </div>
            </div>
            ...
            {allLedger.length === 0 && allDeposits.length === 0 && allWithdrawals.length === 0 ? (
              <div className="text-center py-10 px-4">
                ...
                <div className="text-xs font-medium text-slate-400">No account activity recorded yet</div>
                <div className="text-[11px] text-slate-500 mt-1">
                  Deposits, trades, and payouts will appear here in real time.
                </div>
              </div>
            ) : (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-[10px] text-slate-500 mt-0.5">
                        {new Date(w.requestedAt).toLocaleDateString()} • Net ${(w.amount - w.fee).toFixed(2)}
                      </div>
                    </div>
                    <span

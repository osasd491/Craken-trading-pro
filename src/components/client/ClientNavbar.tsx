        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative hidden sm:block">
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-xs font-semibold text-slate-200 transition-colors"
            >
          ...
          {/* ================= PRIMARY SETTINGS ≡ BUTTON (SCREENSHOT MATCHING) ================= */}
          <button
          ...
          >
            {/* Exact ≡ 3-bar icon styled cleanly as requested */}
